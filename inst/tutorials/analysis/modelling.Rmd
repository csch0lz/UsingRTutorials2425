...
<!-- To hide the solution, use a textual hint. -->
<div id="anova2-hint">
__Hint:__ You may have to install and load the `car` package.
</div>
...
htmlreg(list(model_1,model_1a), #the regression model(s) shown
...
If you want to have full control of your table, create it yourself with packages `broom` and `knitr`.
