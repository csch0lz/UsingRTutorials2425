...
Install the packages in RStudio if necessary, and run the code to see the graph. If you carefully position your cursor on a dot, the respondent's first name will pop up (works better if you select the *Compare data on hover* option).
...
Download the Data Project data file(s) to a directory that you create for your Data Project.
...
* Copy the setwd() command from the RStudio console to the code box in the tutorial.

As long as you do not press the *Start Over* button, the code (and plots) are preserved in this tutorial, so you can use the code later. 
...
In the context of this tutorial, you must load the data in each code box (in RStudio, you only load it once).
