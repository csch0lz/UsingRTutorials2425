...
data.frame(Week = c(1, 1, 2, 2, 3, 3, 4, 4),
           ...
           Topics = c(
             ...
             " Programming: Ch. 14-17 up to p. 322 {18-21 up to 21.3}",
...
SCRUM is a framework for managing teamwork in a __systematic__ and __empirically informed__ manner.

What is SCRUM(-Light)?

-   Four 1-week _"Sprints"_.
-   __Sprint__: Set goals, complete tasks, evaluate.
-   _SCRUM master_: Oversees and facilitates the _Sprint_.
...
<div class="emphasis">
Submit a list of (3-4) team members & a team name on the Canvas discussion board during the break.
</div>
...
-   Click _Start Tutorial_ for tutorial __Session 1: A New Way of Working__ in the _Tutorial_ tab. (Takes some time!)
...
<div class="question" >
Set the colour, shape, and size of the dots.
</div>
...
-   Take some time to complete planning of Sprint 1.
-   Start working on Sprint 1 tasks.

### SCRUM masters update

-   Use 1-2 minutes (per project group) to update the other groups on your first Sprint plan.
