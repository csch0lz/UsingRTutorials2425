...
2.  Explanation: In class "test" at the beginning of each Tuesday
    session (Week 2-4; \~10 min). Add comments to the code you submitted
    in part 1 to precisely describe a) what the code does, and b) why
    you performed each operation. Check the
    [syllabus](https://canvas.uva.nl/courses/40018/assignments/syllabus)
    for an example.
