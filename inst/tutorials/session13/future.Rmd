...
Once you are approved, you can type comments (starting with #) specifying what you want to do in RStudio and GitHub Co-Pilot will generate code for you. Let's try

::: question
Open an R Script and write the following comment: "# Add 3 to 5" Then hit enter. Once GitHub Co-Pilot recommends code for you, hit Tab to accept the recommendation.
:::
...
Then write the following comment: "# Create a scatterplot of bill_length_mm and bill_depth_mm with species as color" and hit enter. Once GitHub Co-Pilot recommends code for you, hit Tab to accept the recommendation.
:::

###

::: question
Experiment with more comments to ask GitHub Co-Pilot to add more layers to the graph. 
:::
