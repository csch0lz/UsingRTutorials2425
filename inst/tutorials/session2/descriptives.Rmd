...
-   Carefully inspect a knitted Quarto document for the presence and layout of plots and tables and for unwanted code or R messages.
...
Knit (render) an Quarto with the knit button.
...
-   but requires the installation of a TeX package (see the [online book on](https://bookdown.org/yihui/rmarkdown/installation.html)Quarto).

::: question
Knit your Quarto document to PDF to check that it works and LaTeX package is correctly installed.
:::
...
-   Knit **Quarto** document to PDF or Word.
