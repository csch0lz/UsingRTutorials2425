...
```{r recodemoney-check}
gradethis::grade_code(
  correct = "You correctly delimited the classes.", 
  incorrect = "It is OK if you used: money > 10 ~ 2 instead of TRUE ~ 2 or if you used money < 1 ~ 0 instead of money == 0 ~ 0."
  )
```
...
*Special use* of `mutate()`: Calculate a new variable value for each case from the values on a variable *for other cases*. 
