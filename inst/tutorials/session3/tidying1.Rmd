...
- AI can be a great coding help, ONCE you have a basic understanding of R.
- When you try to use AI before you understanding the basics:
  - You will likely write low quality prompts.
  - You are unlikely to understand and critically evaluate the output.
- Our recommendation: Learn on your own first. Use AI later to keep developing (e.g. using GitHub Co-Pilot for R).
- In this class, we will not use AI to generate code. The exam will be closed book and without internet connection.
...
Today, we will focus on principle 1 and 2. In the next session, we'll focus on principles 3 and 4.
...
-   Check and begin tidying your complex data sets according to principles 1 and 2.
