...
```
````
And this is how the kitted text looks like:
...
```{r lmfunctions, exercise = TRUE, exercise.setup = "texreg-setup"}
...
```{r broom, exercise = TRUE, exercise.setup = "texreg-setup"}
...
```{r broom2, exercise = TRUE, exercise.setup = "texreg-setup", exercise.lines = 6}
model_1a %>% 
...
```{r broom3, exercise = TRUE, exercise.setup = "texreg-setup"}
...
```{r kable, exercise = TRUE, exercise.setup = "texreg-setup", exercise.eval = TRUE, exercise.lines = 17}
model_1a %>% 
  tidy(conf.int = TRUE, conf.level = 0.95) %>% 
  mutate(
...
# Important: You plot summaries, not the original observations.
```
